  	...
  	<div class="side-menu">
  		<nav class="navbar navbar-default" role="navigation">
            ...
            <li>Agent:</li><li><select name="agentss">
              ...
              <?php
                $sql_query = "SELECT * FROM agent group by a_lname order by a_lname ASC";
                 if ($result = $mysqli->query($sql_query)){
                    while ($row = $result->fetch_assoc()) {
                    echo "<option value='".$row['id']."'>".$row['a_lname']." , ".$row['a_fname']."</option>";}}?>
                </select></li>
                <li>Plan:</li><li><select name="plannes">
                  ...
                  include("connect.php");
                    ...
                    <center><a href="admin.php"><input type="button" value="Add" onclick="admin.php"></a><a href="#"><input type="button" value="Rest"></a></center></li></li>
  				</ul>
  			</div><!-- /.navbar-collapse -->
  		</nav>
