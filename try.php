...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="images/headerr1.png" alt="New York" width="1200" height="700">
      ...
      <div class="item">
        <img src="images/headerr1copy.png" alt="Chicago" width="1200" height="700">
        <div class="carousel-caption">
          <h3>Chicago</h3>
      ...
      <div class="item">
        <img src="images/maxima.png" alt="Los Angeles" width="1200" height="700">
        <div class="carousel-caption">
          <h3>LA</h3>
...
<div id="band" class="container text-center">
  <h3>The Great Provider General Insurance Agency</h3>
    ...
    <div class="row text-center">
      <div class="col-sm-4">
        <div class="thumbnail">
          ...
          <p><strong>Insular Life</strong></p>
      ...
      <div class="col-sm-4">
        <div class="thumbnail">
          ...
          <p><strong>Leuterio Realty</strong></p>
